...
/// # Arguments
///
/// * `label` - A byte slice representing the label. The label is the prefix of the key.
...
pub fn epoch_key_pairs_id(
    ...
    leaf_index: u32,
) -> Result<Vec<u8>, <RedbStorage as StorageProvider<CURRENT_VERSION>>::Error> {
...
mod tests {
    ...
    fn test_epoch_key_pairs_id() {
        ...
        // As well as a mock. For brevity, we'll just test the function signature.
    }
}
